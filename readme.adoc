...
:vscode: {wiki}3oas[image:{icons}brand-vscode.svg[]]
:debian: {wiki}9VuS[image:{icons}brand-debian.svg[]]
:golang: {wiki}9VuF[image:{icons}brand-golang.svg[]]
...
| **in {golang}**. when i was 10 i'd been programming in
...
**for {debian}**. in the same ages, my want to hack a wi-fi
...
**with {vscode}** as it more universal and easier than
{wiki}PoB[`vim`].
