...
on thinkpads with lubuntu. had take one and experimented with https://w.wiki/9VuS[`debian`], 
https://w.wiki/5kfD[`opensuse`], https://w.wiki/9VuV[`arch`], https://w.wiki/7caP[`fedora`], 
and other forgettable.

**with https://w.wiki/3oas[`vscode`]** as it universal and easier to setup for 
small projects in opposite to https://w.wiki/PoB[`vim`].
